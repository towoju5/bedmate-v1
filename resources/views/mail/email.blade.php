...
<head>
    ...
    <link
        href="//fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,200;1,300;1,400;1,500;1,600;1,800&display=swap"
        rel="stylesheet" />
    <style>
        * {
            margin: 0;
...
<body>
    <section class="banner">
        <div>
            <img src="//cumrid.com.ng/Assets/Heart.png" alt="" class="logo">
        </div>
        <img src="//cumrid.com.ng/Assets/cumrid.png" alt="" class="logo">
